...
export default function KiwifyPage() {
  ...
  const loadIntegrations = async () => {
    try {
      setLoading(true);
      // Simular dados das integrações Kiwify
      const mockIntegrations: KiwifyIntegration[] = [
        {
          id: 'KW001',
          productName: 'Projeto Trump Kiwify',
          token: 'KW123abc456def789',
          plan: 'VIP',
          webhookUrl: `${window.location.origin}/api/webhooks/kiwify/KW123abc456def789`,
          status: 'ACTIVE',
        ...
        {
          id: 'KW002',
          productName: 'Close Friends LITE Kiwify',
          token: 'KW456def789ghi012',
          plan: 'LITE',
          webhookUrl: `${window.location.origin}/api/webhooks/kiwify/KW456def789ghi012`,
          status: 'ACTIVE',
