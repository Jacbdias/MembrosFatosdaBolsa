...
// 🚀 HOOK CORRIGIDO PARA BUSCAR COTAÇÕES DOS MICRO CAPS DO DATASTORE
function useMicroCapsIntegradas() {
  ...
  // 📊 OBTER DADOS DA CARTEIRA MICRO CAPS DO DATASTORE
  ...
  const buscarCotacoesIntegradas = React.useCallback(async () => {
    try {
      ...
      console.log('🔥 BUSCANDO COTAÇÕES INTEGRADAS PARA MICRO CAPS');
      console.log('📋 Ativos do DataStore:', microCapsData);
      ...
      for (const ticker of tickers) {
        try {
          ...
          const response = await fetch(apiUrl, {
            ...
            headers: {
              'Accept': 'application/json',
              'User-Agent': 'MicroCaps-Portfolio-App'
            }
          });
...
export default function MicroCapsPage() {
  ...
  const { ativosAtualizados, cotacoesAtualizadas, setCotacoesAtualizadas, loading } = useMicroCapsIntegradas();
