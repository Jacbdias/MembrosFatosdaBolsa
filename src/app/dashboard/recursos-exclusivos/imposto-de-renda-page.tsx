  ...
  const recursos = [
    {
      ...
      icon: <FileTextIcon />,
      href: '/recursos-exclusivos/imposto-de-renda',
    ...
    },
    {
      ...
      icon: <ChatIcon />,
      href: '/recursos-exclusivos/telegram',
    ...
    },
    {
      ...
      href: '/recursos-exclusivos/lives-e-aulas',
    ...
    },
    {
      ...
      icon: <AirplaneIcon />,
      href: '/recursos-exclusivos/milhas-aereas',
    ...
    },
    {
      ...
      icon: <BookOpenIcon />,
      href: '/recursos-exclusivos/ebooks',
    ...
    },
    {
      ...
      icon: <TableIcon />,
      href: '/recursos-exclusivos/planilhas',
