...
function useInternationalDividends() {
  ...
  // 🎲 FUNÇÃO PARA GERAR PREÇOS DINÂMICOS REALISTAS
  const generateRealisticPrice = React.useCallback((basePrice: number, ticker: string) => {
...
export default function Page(): React.JSX.Element {
  ...
  // 🔥 BUSCAR COTAÇÕES REAIS DOS ATIVOS INTERNACIONAIS
  const { portfolio: dividendosInternacionais, loading: portfolioLoading, error: portfolioError } = useInternationalDividends();
