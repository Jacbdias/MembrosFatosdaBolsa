...
export const navItems = [
  ...
  // 🛡️ MENU ADMINISTRATIVO
  {
    ...
    items: [
      ...
      // 🔗 NOVA SEÇÃO - INTEGRAÇÕES COMPLETAS
      {
      ...
      // 📊 NOVO - RENOVAÇÕES (substitui Configurações)
      {
        key: 'admin-renovacoes',
        title: 'Renovações',
        href: paths.dashboard.adminRenovacoes,
        icon: 'chart-bar', // ou use 'refresh' se tiver
      ...
      // ❌ REMOVIDO - Configurações (substituído por Renovações)
      // {
      //   key: 'admin-settings',
      //   title: 'Configurações',
